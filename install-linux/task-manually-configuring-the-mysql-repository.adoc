...
. 下載適合您安裝的MySQL儲存庫： `+wget http://repo.mysql.com/yum/mysql-8.0-community/el/7/x86_64/mysql80-community-release-el7-3.noarch.rpm+`
. 設定MySQL儲存庫： `yum install mysql80-community-release-el7-3.noarch.rpm`
