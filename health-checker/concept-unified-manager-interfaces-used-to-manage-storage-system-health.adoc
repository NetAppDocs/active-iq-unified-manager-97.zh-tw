...
sidebar: sidebar 
keywords:  
summary: 這些章節提供Active IQ Unified Manager 有關兩種使用者介面的資訊、這些介面可用來疑難排解資料儲存容量、可用度和保護問題。這兩個UI是Unified Manager Web UI和維護主控台。 
---
...
[role="lead"]
這些章節提供Active IQ Unified Manager 有關兩種使用者介面的資訊、這些介面可用來疑難排解資料儲存容量、可用度和保護問題。這兩個UI是Unified Manager Web UI和維護主控台。
